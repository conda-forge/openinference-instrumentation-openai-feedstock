About openinference-instrumentation-openai-feedstock
====================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/openinference-instrumentation-openai-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/openinference-instrumentation-openai-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add openinference-instrumentation-openai
# for installing globally
pixi global install openinference-instrumentation-openai
```
...
It is possible to list all of the versions of `openinference-instrumentation-openai` available on your platform:
...
```
pixi search openinference-instrumentation-openai --channel conda-forge
```
